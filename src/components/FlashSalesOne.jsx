          ...
          <Slider {...settings}>
            <div>
              <div className="flash-sales-item rounded-16 overflow-hidden z-1 position-relative flex-align flex-0 justify-content-between gap-8">
                {/* <img
                  src="assets/images/bg/flash-sale-bg.png"
                  alt=""
                ...
                <div className="flash-sales-item__thumb d-sm-block d-none">
                  <img src="assets/images/thumbs/flash-sale-img1.JPG" alt="" />
                </div>
                <div className="flash-sales-item__content ms-sm-auto">
                  <h6 className="text-32 mb-20">Hand made beads</h6>
            ...
            <div>
              <div className="flash-sales-item rounded-16 overflow-hidden z-1 position-relative flex-align flex-0 justify-content-between gap-8">
                ...
                /> */}
                <div className="flash-sales-item__thumb d-sm-block d-none">
                  <img src="assets/images/thumbs/flash-sale-img2.JPG" alt="" />
                </div>
                <div className="flash-sales-item__content ms-sm-auto">
                  <h6 className="text-32 mb-20">black Shop</h6>
            ...
            <div>
              <div className="flash-sales-item rounded-16 overflow-hidden z-1 position-relative flex-align flex-0 justify-content-between gap-8">
                ...
                /> */}
                <div className="flash-sales-item__thumb d-sm-block d-none">
                  <img src="assets/images/thumbs/flash-sale-img3.JPG" alt="" />
                </div>
                <div className="flash-sales-item__content ms-sm-auto">
                  <h6 className="text-32 mb-20">Shea Butter</h6>
