              ...
              <div className="mt-32">
                ...
                <div className="payment-item">
                  ...
                  {selectedPayment === "payment2" && (
                    <div className="payment-item__content px-16 py-24 rounded-8 bg-main-50 position-relative d-block">
                      <p className="text-gray-800">
                        Please enter your card details below to complete the
                        payment. We accept all major credit and debit cards.
                        Your payment information is securely processed and
                        encrypted to ensure your privacy and security. Once the
                        payment is confirmed, you will receive an email with
                ...
                <div className="payment-item">
                  ...
                  {selectedPayment === "payment3" && (
                    <div className="payment-item__content px-16 py-24 rounded-8 bg-main-50 position-relative d-block">
                      <p className="text-gray-800">
                        Cash on delivery (COD) allows you to pay for your order
                        in cash at the time of delivery. This payment method is
                        convenient for those who prefer not to use online
                        payment options. Please ensure you have the exact amount
                        ready, as the delivery personnel may not have change.
                        Your order will be processed and shipped, and you will
                        make the payment when you receive your items.
                      </p>
                    </div>
                  )}
                </div>
